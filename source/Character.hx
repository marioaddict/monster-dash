	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'marelia':
				// Marelia ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Marelia','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Marelia Idle', 24);
				animation.addByPrefix('singUP', 'Marelia Up', 24);
			...
			case 'mareliaCharged':
				// Marelia ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('MareliaCharged','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'MareliaCharged Idle', 24);
				animation.addByPrefix('singUP', 'MareliaCharged Up', 24);
